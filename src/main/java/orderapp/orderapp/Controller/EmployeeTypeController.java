...
public class EmployeeTypeController {
    ...
    public ResponseEntity<ResponseBody> addEmployeeType(@RequestBody String title,String slug) {
        try {
            return ResponseWriter.created("Berhasil menambahkan data", employeeTypeService.createEmployeeType(title));
    ...
    public ResponseEntity<ResponseBody> updateEmployeeType(@PathVariable String id,@RequestBody String title){
        try {
            return ResponseWriter.created("Berhasil Merubah Data",employeeTypeService.updateEmployeeType(id,title));
        } catch (NotFoundException e){
